...
- (void)onTabButtonClicked:(UIButton *)button
{
    ...
    switch (index) {
        case 0:
            [MobClick event:@"click_messgae_id" attributes:@{@"OrgName" : schoolName}];
            break;
        case 1:
            [MobClick event:@"click_contact_id" attributes:@{@"OrgName" : schoolName}];
            break;
        case 2:
//            [MobClick event:@"browse_appbox_id" attributes:@{@"OrgName" : schoolName}];
            break;
        case 3:
            [MobClick event:@"click_discovery_id" attributes:@{@"OrgName" : schoolName}];
            break;
        case 4:
            [MobClick event:@"click_me_id" attributes:@{@"OrgName" : schoolName}];
            break;
        default:
            break;
    }
