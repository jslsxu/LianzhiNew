...
- (void)banner:(ZYBannerView *)banner didSelectItemAtIndex:(NSInteger)index{
    ...
    if(bannerItem.url){
        ...
        NSString *schoolName = [UserCenter sharedInstance].curSchool.schoolName;
        [MobClick event:@"click_banner_id" attributes:@{@"OrgName" : schoolName}];
...
- (void)TNBaseTableViewControllerItemSelected:(TNModelItem *)modelItem atIndex:(NSIndexPath *)indexPath
{
    ...
    if([url hasPrefix:@"http"])
    {
        ...
        {
            if([item.name isEqualToString:@"掌上校园"])
                [MobClick event:@"click_campus_id" attributes:@{@"OrgName" : schoolName}];
...
//            [MobClick event:@"click_notice_id" attributes:@{@"OrgName" : schoolName}];
...
//            [MobClick event:@"click_contact_id" attributes:@{@"OrgName" : schoolName}];
        ...
        else if([host isEqualToString:@"class"])//班博客
        {
            if([[UserCenter sharedInstance].curSchool.allClasses count] > 1){
                ...
                [selectionVC setSelection:^(ClassInfo *classInfo) {
                    ...
                    [MobClick event:@"click_class_blog_id" attributes:@{@"OrgName" : schoolName}];
...
//            [CurrentROOTNavigationVC pushViewController:growthRecordVC animated:YES];
            if([UserCenter sharedInstance].curSchool.allClasses.count == 0)
            {
                ...
                [selectionVC setSelection:^(ClassInfo *classInfo) {
                    ...
                    [MobClick event:@"click_record_id" attributes:@{@"OrgName" : schoolName}];
        ...
        else if([host isEqualToString:@"practice"])//联系
        {
            ...
            [MobClick event:@"click_practice_id" attributes:@{@"OrgName" : schoolName}];
        ...
        else if([host isEqualToString:@"leave"])//考勤
        {
            ...
            if([allClassArray count] == 0){
                ...
                [MobClick event:@"click_classattendance_id" attributes:@{@"OrgName" : schoolName}];
        ...
        else if ([host isEqualToString:@"account"])//炼制账户
        {
            ...
            [MobClick event:@"click_lzaccount_id" attributes:@{@"OrgName" : schoolName}];
        ...
        else if([host isEqualToString:@"leave_my_record"])//我的考勤
        {
            ...
            [MobClick event:@"leave_my_record" attributes:@{@"OrgName" : schoolName}];
