...
- (void)startUploading:(ClassZoneItem *)item
{
    ...
    [MobClick event:@"send_blog_photo_id" attributes:@{@"OrgName" : schoolName}];
...
- (void)onActionClicked:(ClassZoneItemCell *)cell
{
    ...
    ActionView *actionView = [[ActionView alloc] initWithPoint:point praised:praised action:^(NSInteger index) {
        if(index == 0)
        {
            ...
            {
                NSString *schoolName = [UserCenter sharedInstance].curSchool.schoolName;
                [MobClick event:@"click_blog_like_id" attributes:@{@"OrgName" : schoolName}];
...
- (void)onActionViewCommit:(NSString *)content
{
    ...
    NSString *schoolName = [UserCenter sharedInstance].curSchool.schoolName;
    [MobClick event:@"click_blog_comment_id" attributes:@{@"OrgName" : schoolName}];
